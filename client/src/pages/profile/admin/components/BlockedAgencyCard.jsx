...
export default function BlockedAgencyCard({
  agency,
  isUnblocking,
  setIsUnblocking,
  unblockAgencyId,
  ...
  return (
    <div>
      <div className="bg-white shadow-sm border rounded-2xl p-5 w-full max-w-md mx-auto hover:shadow-md transition-all duration-300 ease-in-out">
        ...
        <button
          onClick={() => {
            setUnblockAgencyId(agency._id);
            setIsUnblocking(true);
          }}
          className=" mt-3 text-sm px-3 py-1 rounded-lg bg-yellow-100 text-yellow-800 hover:bg-yellow-200 transition"
        >
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full border border-green-200">
            <div className="flex flex-col items-center">
              ...
              <div className="flex gap-4 mt-2">
                <button
                  onClick={() => handleUnblock(unblockAgencyId)}
