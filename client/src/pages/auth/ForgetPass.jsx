...
export default function ForgetPass() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <form
        className="flex flex-col w-96 gap-3 py-12 px-4 text-white bg-gradient-to-br from-green-400 to-green-700 rounded-2xl shadow-slate-400 shadow-2xl"
          ...
          >
            {!loadingBtn ? (
              ...
              <span className="flex justify-center">
                <svg
                  aria-hidden="true"
                  className="w-8 h-8 text-gray-200 animate-spin dark:text-white-500 fill-blue-900"
                  viewBox="0 0 100 101"
                  fill="none"
