  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <form
        ...
        className="flex flex-col  w-96 gap-3 py-12 px-4 text-white  bg-gradient-to-br from-green-400 to-green-700 rounded-2xl shadow-gray-800 shadow-2xl"
      >
        ...
        <p className="text-center">
          ...
          <Link className="text-gray-600 font-medium" to={"/signup"}>
            Signup
          </Link>
        </p>
      </form>
